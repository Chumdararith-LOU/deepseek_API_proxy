...
export const DEEPSEEK_THINK_TAG_PATTERN = new RegExp(
  `<\\/?(?:${THINK_TAG_NAMES.join("|")})(?:\\s[^>]{0,100})?\\/?>`,
  "gi",
);
export const DEEPSEEK_THINK_BLOCK_START = new RegExp(`<(?:${THINK_TAG_NAMES.join("|")})[\\s>]`, "i");
