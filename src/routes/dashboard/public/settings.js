...
var SETTINGS_SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      { key: 'DEEPSEEK_FETCH_TIMEOUT_MS', label: 'DEEPSEEK_FETCH_TIMEOUT_MS', type: 'number' },
  ...
  {
    title: 'Claude Code',
    desc: 'Auto-configure deepseek-gateway as a Claude Code proxy. Creates .claude/settings.json in the project root.',
...
function renderClaudeCodeInfo() {
  ...
  var port = settingsData['PORT'] || '26406';
  var baseUrl = 'http://' + host + ':' + port;
  return (
    '<div class="settings-section" style="margin-top:24px">' +
    '<div class="settings-section-title">Claude Code Proxy Active</div>' +
    '<p class="settings-section-desc">deepseek-gateway is configured as a Claude Code proxy. ' +
...
async function handleDeleteAllChats() {
  var bodyHtml =
    '<p style="margin:0 0 12px">This will permanently <strong>delete all conversations</strong> from every DeepSeek account.</p>' +
